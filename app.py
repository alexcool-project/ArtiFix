...
# --- CONVERTI FORMATI (TASK 3: gestione formati non-mesh) ---
    ...
    with col_main:
        ...
        if uploaded_file:
            ...
            # ============================================
            # CASO 3 — PDF → info + rilevamento 3D PDF
            # ============================================
                ...
                if is_3d_pdf:
                    ...
                    **Cosa puoi fare con un 3D PDF:**
                    ...
                    st.markdown("""
                    **Cosa puoi fare con un PDF:**
                    - Visualizzarlo con qualsiasi lettore PDF
                    - Convertirlo in immagini (PNG, JPG)
                    - Estrarre il testo
                    - **Conversione in 3D PDF** — carica un file mesh nella sezione "Converti Formati" e scegli PDF come output
                    """)
