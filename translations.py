...
TRANSLATIONS = {
    "it": {
        ...
        "repair_upload_hint": "💡 Formati supportati: DXF, STL, OBJ, PLY, GLB, GLTF, FBX, 3MF, DAE, WRL, OFF, U3D, IFC, SHP, GEOJSON, KML, GPX, SVG, 3D PDF, DOCX, XLSX. I formati proprietari (DWG, SKP, RVT, STEP, IGES) devono essere esportati in DAE o OBJ.",
        ...
        "viewer_upload_hint": "💡 Formati supportati: STL, OBJ, PLY, GLB, GLTF, FBX, 3MF, DAE, WRL, OFF, U3D, 3D PDF. Il PDF deve contenere un modello 3D incorporato (U3D o PRC).",
...
La presente Cookie Policy può essere soggetta ad aggiornamenti.""",
    ...
    "en": {
        ...
        "repair_upload_hint": "💡 Supported formats: DXF, STL, OBJ, PLY, GLB, GLTF, FBX, 3MF, DAE, WRL, OFF, U3D, IFC, SHP, GEOJSON, KML, GPX, SVG, 3D PDF, DOCX, XLSX. Proprietary formats (DWG, SKP, RVT, STEP, IGES) must be exported to DAE or OBJ.",
        ...
        "viewer_upload_hint": "💡 Supported formats: STL, OBJ, PLY, GLB, GLTF, FBX, 3MF, DAE, WRL, OFF, U3D, 3D PDF. The PDF must contain an embedded 3D model (U3D or PRC).",
